...
function BackgroundColorPicker({ color, onChangeColor }) {
  ...
  function handleReset() {
    setHexInput(DEFAULT_BACKGROUND_COLOR)
    setError('')
    onChangeColor(DEFAULT_BACKGROUND_COLOR)
  }
  ...
  return (
    <div>
      <div className="flex items-center gap-2">
        <input
          type="color"
          value={normalizeHexColor(color) || DEFAULT_BACKGROUND_COLOR}
