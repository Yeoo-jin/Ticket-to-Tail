import { BOARD_HEIGHT, SEGMENT_WIDTH } from '../../utils/panoramaLayouts'

// 하나의 master board(boardWidth×1350, boardWidth는 분할 수에 따라 3240 또는 4320)를
// 세 구간 또는 네 구간으로 "잘라" 보여주는 창(viewport) 하나.
// 같은 boardContent를 여러 PanoramaViewport에 그대로 넘기면, 각 인스턴스는 자신의
// segmentIndex만큼 board를 왼쪽으로 이동시켜 보여주므로 항상 같은 자료로부터
...
function PanoramaViewport({ segmentIndex, boardWidth, children, displayScale = 1, viewportRef, className = '' }) {
